...
export default function NotesPage() {
  ...
  useEffect(() => {
    const shouldLockUi = uploadOverlayState !== "idle";
    setUiOverlayActive(shouldLockUi || showUploadTypePicker);
    return () => setUiOverlayActive(false);
  }, [setUiOverlayActive, uploadOverlayState, showUploadTypePicker]);
  ...
  async function handleUpload(fileOverride?: File, ocrMode: UploadOcrMode = "printed") {
    ...
    >
          ...
          <div className="px-4 pt-4 pb-3 border-b border-white/10">
            ...
            <div className="space-y-2">
              ...
              <Button
                ...
                disabled={uploading || showUploadTypePicker}
      ...
      {showUploadTypePicker && pendingUploadFile && (
        <motion.div
          ...
          data-ocid="notes.upload.type.picker"
        >
            ...
            <div className="mt-4 flex gap-2">
              <Button
                ...
                onClick={() => {
                  ...
                  if (selectedFile) {
                    void handleUpload(selectedFile, selectedMode);
                  }
                }}
              >
                Continue Upload
